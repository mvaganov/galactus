...
//	}
//
//	public AgentForce RefreshSensorOwner(AgentForce whoIsSensing) {
...
//			AgentSoul soul = null;
//			do {
//				pf = t.GetComponent<AgentForce> ();
//				if (!pf) {
//                    soul = t.GetComponent<AgentSoul> ();
//					if (soul) {
//                        pf = soul.GetBiggestBody();//GetPossesed();
//					}
//				}
//				t = t.parent;
//			} while (!pf && t);
...
//				AgentForce reat = hits[i].collider.gameObject.GetComponent<AgentForce>();
//				ResourceCollectable rn = (reat)? null : hits[i].collider.gameObject.GetComponent<ResourceCollectable>();
