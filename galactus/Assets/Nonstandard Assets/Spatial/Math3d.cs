...
public class Math3d : MonoBehaviour {
	...
	/// <returns>a vector in the same direction with the given addition to its size</returns>
	public static Vector3 AddVectorLength(Vector3 vector, float size){
		float magnitude = Vector3.Magnitude(vector);
		Vector3 norm = vector / magnitude;
		magnitude += size;
		return norm * magnitude;
	}
	
	/// <returns>a vector in the same direction with the given size</returns>
	public static Vector3 MakeVectorLength(Vector3 vector, float size){
		return vector.normalized * size;
	}

	/// <returns>rotational difference from A to B</returns>
	...
	public static bool LinePlaneIntersection(out Vector3 intersection, Vector3 linePoint, Vector3 lineVec, Vector3 planeNormal, Vector3 planePoint){
		...
		if(dotDenominator != 0.0f){
			...
			vector = MakeVectorLength(lineVec, length);
	...
	public static Vector3 ProjectPointOnPlane(Vector3 planeNormal, Vector3 planePoint, Vector3 point){
		...
		translationVector = MakeVectorLength(planeNormal, distance);
	...
	/// <param name="alignWithVector">Align with vector: in world space</param>
	/// <param name="alignWithNormal">Align with normal: in world space</param>
