...
public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
{
	...
	public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
		...
		if (_Foldout) return (_Dictionary.Count + 1) * 17f;
		return 17f;
	}
...
[CustomPropertyDrawer(typeof(Dictionary_string_float))]
public class MyDictionaryDrawer0 : DictionaryDrawer<string, float> { }

[CustomPropertyDrawer(typeof(Dictionary_string_int))]
public class MyDictionaryDrawer1 : DictionaryDrawer<string, int> { }

[CustomPropertyDrawer(typeof(Dictionary_KeyCode_GameObject))]
public class MyDictionaryDrawer2 : DictionaryDrawer<KeyCode, GameObject> { }

[CustomPropertyDrawer(typeof(Dictionary_string_string))]
public class MyDictionaryDrawer3 : DictionaryDrawer<string, string> { }
